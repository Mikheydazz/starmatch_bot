'''
Функции, необходимые для расчёта матрицы судьбы и матрицы совместимости
'''
def sum_digits(num):
...
# print(f"Совместимость: {result['percentage']}%")
# print(f"Детали:")
# print(f"  - По матрице: {result['details']['matrix_score']:.1f}%")
# print(f"  - По стихиям: {result['details']['elements_score']:.1f}%")
# print(f"  - По ключевым числам: {result['details']['key_numbers_score']:.1f}%")

# # Вывод матриц
# print("\nМатрица человека 1:")
# print_matrix(result['person1']['matrix'])

# print("\nМатрица человека 2:")
# print_matrix(result['person2']['matrix'])